...
//        messageClasses.add(UnknownMessage.class);
        ...
        System.out.println("// Generated by jadescript.content.onto.MessageContent#main(String[]), for MessageContent.java:");
        ...
        System.out.println("// End generated part.");

        System.out.println("// Generated by jadescript.content.onto.MessageContent#main(String[]), for Ontology_Vocabulary.java:");
        for (Class<?> messageClass : messageClasses) {
            final TypeVariable<? extends Class<?>>[] typeParameters = messageClass.getTypeParameters();
            if (typeParameters.length > 1) {
        ...
        System.out.println("// Generated by jadescript.content.onto.MessageContent#main(String[]), for Ontology.java, inside its zero-parameter ctor (part 1):");
        for (Class<?> messageClass : messageClasses) {
            final TypeVariable<? extends Class<?>>[] typeParameters = messageClass.getTypeParameters();
            if (typeParameters.length > 1) {
        ...
        System.out.println("// Generated by jadescript.content.onto.MessageContent#main(String[]), for Ontology.java, inside its zero-parameter ctor (part 2):");
        for (Class<?> messageClass : messageClasses) {
            final TypeVariable<? extends Class<?>>[] typeParameters = messageClass.getTypeParameters();
            if (typeParameters.length > 1) {
                ...
                for (int i = 0; i < typeParameters.length; i++) {
                    ...
                    if (typeParameter.getBounds().length == 1) {
                        ...
                        if (typeName.contains("java.util.List")) {
                            ...
                            System.out.println(schemaName + ".add(" + messageClass.getSimpleName().toUpperCase() +
                                    "_ELEMENT" + i + ", (AgentActionSchema) AgentActionSchema.getBaseSchema());");
                        } else if (typeName.contains("JadescriptProposition")) {
                            System.out.println(schemaName + ".add(" + messageClass.getSimpleName().toUpperCase() +
                                    "_ELEMENT" + i + ", (PredicateSchema) PredicateSchema.getBaseSchema());");
    ...
    public static ContentElement prepareContent(ContentElement content, Performative performative) {
        ...
        if (performative.equals(Performative.CFP)) {
            return prepareCFPMessage((Tuple.Tuple2<JadescriptAction, JadescriptProposition>) content);
    ...
    // Generated by jadescript.content.onto.MessageContent#main(String[]), for MessageContent.java:
    ...
    public static class CFPMessageContent extends Tuple.Tuple2<jadescript.content.JadescriptAction, jadescript.content.JadescriptProposition> {
        public static CFPMessageContent __fromTuple(Tuple.Tuple2<jadescript.content.JadescriptAction, jadescript.content.JadescriptProposition> tuple) {
            CFPMessageContent result = new CFPMessageContent();
            result.setElement0(tuple.getElement0());
            result.setElement1(tuple.getElement1());
            return result;
        }
    ...
    public static ContentElement prepareCFPMessage(Tuple.Tuple2<jadescript.content.JadescriptAction, jadescript.content.JadescriptProposition> content) {
        return CFPMessageContent.__fromTuple(content);
    }
