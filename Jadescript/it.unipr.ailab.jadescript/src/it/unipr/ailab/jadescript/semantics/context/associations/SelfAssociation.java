...
public class SelfAssociation implements Comparable<SelfAssociation>, Association {
    private final IJadescriptType self;
    private final SelfAssociationKind associationKind;

    public SelfAssociation(IJadescriptType self, SelfAssociationKind associationKind) {
        this.self = self;
    ...
    public static SelfAssociation applyExtends(SelfAssociation input){
        return new SelfAssociation(input.getSelf(), applyExtends(input.getAssociationKind()));
    }
...
ST
    ...
    public int compareTo(@NotNull SelfAssociation o) {
        return Comparator.<SelfAssociation>comparingInt(a -> a.getAssociationKind().distanceOrdinal())
                .compare(this, o);
    }
     ...
     * </pre>
     */
    public enum T implements SelfAssociationKind {INSTANCE;
     ...
     * </pre>
     */
    public enum ST implements SelfAssociationKind {INSTANCE;
