...
public class OntologyDeclarationSupportContext extends TopLevelDeclarationContext
    ...
    public Stream<? extends CallableSymbol> searchCallable(
        ...
        Stream<? extends CallableSymbol> stream = Maybe.toListOfMaybes(input.__(Ontology::getFeatures)).stream()
                ...
                .map(OntologyElementConstructorSymbol::new);
    ...
    private class OntologyElementConstructorSymbol implements CallableSymbol {
        ...
        private final Maybe<ExtendingFeature> input;

        public OntologyElementConstructorSymbol(Maybe<ExtendingFeature> input) {
            this.input = input;
