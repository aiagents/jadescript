...
public interface PerceptPerceivedContext extends SemanticsConsts {
    ...
    default Stream<NamedSymbol> getPerceptContentStream(Predicate<String> name, Predicate<IJadescriptType> readingType, Predicate<Boolean> canWrite) {
        ...
        return stream.map(__ -> new ContextGeneratedReference(PERCEPT_CONTENT_VAR_NAME, getPerceptContentType()));
    }
