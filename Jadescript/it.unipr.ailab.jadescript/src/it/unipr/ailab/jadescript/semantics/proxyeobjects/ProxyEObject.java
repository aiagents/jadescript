...
public class ProxyEObject implements EObject {
	...
	public static <T extends EObject> T reflectiveProxyEObject(T input1, EObject input2, Class<?> targetInterface){
        ...
        return (T) Proxy.newProxyInstance(
                ...
                (proxy, method, args) -> {
                    switch (method.getName()) {
                        ...
                        case "eGet":
                            if (args.length == 1) {
                                return input2.eGet((EStructuralFeature) args[0]);
                            } else {
                                return input2.eGet((EStructuralFeature) args[0], (Boolean) args[1]);
                            }
                        case "eSet":
                            input2.eSet(((EStructuralFeature) args[0]), args[1]);
                            return null;
                        case "eIsSet":
                        ...
                        case "eUnset":
                            ...
                            return null;
                        case "eInvoke":
                            return input2.eInvoke((EOperation) args[0], (EList<?>) args[1]);
                        case "eAdapters":
                        ...
                        case "eNotify":
                            ...
                            return null;
                        default:
                            return input1.getClass().getMethod(method.getName(), method.getParameterTypes())
                                    .invoke(input1, args);
                    }
                }
        );
