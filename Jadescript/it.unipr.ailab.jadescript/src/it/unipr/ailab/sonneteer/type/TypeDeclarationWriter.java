...
public abstract class TypeDeclarationWriter extends ClassMemberWriter implements Writer, Annotable, ITypeDeclarationWriter {
    public TypeDeclarationWriter(Visibility visibility, boolean isFinal, boolean isStatic) {
